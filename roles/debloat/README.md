...
~~~bash
ansible-playbook site.yml --tags debloat
~~~

## Variables

Role defaults (when present):
- roles/debloat/defaults/main.yml
...
~~~bash
ansible-playbook -i inventories/test/hosts.yml site.yml --tags debloat --syntax-check
~~~
